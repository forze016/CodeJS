...
Por ejemplo, si el número proporcionado es 10, los múltiplos de 3 o 5 menores que 10 son 3, 5, 6 y 9. La suma de estos números es 23. Por lo tanto, la función debería devolver 23 en este caso. */
...
ya que incluye todas las letras del alfabeto de la A a la Z al menos una vez, sin importar si son mayúsculas o minúsculas.
La tarea es crear una función que tome una cadena como entrada y determine si es un pangrama o no. Debes retornar True si la cadena
 es un pangrama y False si no lo es. Además, debes ignorar los números y la puntuación en la cadena al realizar esta verificación. */
